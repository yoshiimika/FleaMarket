/******/ (() => { // webpackBootstrap
/*!*****************************************************!*\
  !*** ./resources/js/edit-category-brand-handler.js ***!
  \*****************************************************/
document.querySelectorAll('.edit-form__category-input').forEach(function (checkbox) {
  checkbox.addEventListener('change', function () {
    var parentLabel = this.closest('.edit-form__category');
    ...
    var selectedCategories = Array.from(document.querySelectorAll('.edit-form__category-input:checked')).map(function (input) {
      return input.value;
    });
