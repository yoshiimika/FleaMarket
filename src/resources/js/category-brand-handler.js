document.querySelectorAll('.sell-form__category-input').forEach((checkbox) => {
    checkbox.addEventListener('change', function () {
        const parentLabel = this.closest('.sell-form__category');
        ...
        const selectedCategories = Array.from(
            document.querySelectorAll('.sell-form__category-input:checked')
